    ...
    public partial class AddPublishersTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__jobs__6E32B6A5D7554D16", x => x.job_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__employee__job_id__34C8D9D1",
                        column: x => x.job_id,
                        principalTable: "jobs",
                        principalColumn: "job_id");
                    table.ForeignKey(
                        name: "FK__employee__pub_id__37A5467C",
                        column: x => x.pub_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__pub_info__pub_id__300424B4",
                        column: x => x.pub_id,
                        principalTable: "publishers",
                        principalColumn: "pub_id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__titles__pub_id__1A14E395",
                        column: x => x.pub_id,
                        principalTable: "publishers",
                        principalColumn: "pub_id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK__discounts__stor___286302EC",
                        column: x => x.stor_id,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK__roysched__title___267ABA7A",
                        column: x => x.title_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__sales__stor_id__239E4DCF",
                        column: x => x.stor_id,
                        principalTable: "stores",
                        principalColumn: "stor_id");
                    table.ForeignKey(
                        name: "FK__sales__title_id__24927208",
                        column: x => x.title_id,
                        principalTable: "titles",
                        principalColumn: "title_id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__titleauth__au_id__1DE57479",
                        column: x => x.au_id,
                        principalTable: "authors",
                        principalColumn: "au_id");
                    table.ForeignKey(
                        name: "FK__titleauth__title__1ED998B2",
                        column: x => x.title_id,
                        principalTable: "titles",
                        principalColumn: "title_id");
                });
